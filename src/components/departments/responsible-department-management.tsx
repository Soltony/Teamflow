...
import { createDepartment, deleteDepartment, updateDepartment } from "@/app/responsible-departments/actions";
...
export function ResponsibleDepartmentManagement({ initialDepartments }: { initialDepartments: Department[] }) {
  ...
  const canManage = hasPermission('responsible-depts:view'); // Assuming one permission for now
